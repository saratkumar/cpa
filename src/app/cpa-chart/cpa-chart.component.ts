...
export class CpaChartComponent {
  ...
  jobInfo: any = [
    ...
    "APP_CODE IDOD_SG_LCR_LOANDEPO5_SYS1 to PDM_SG_RM_FPRO_SELL_BUY_SYS1 (26.00) IDOD_SG_LCR_LOANDEPO5_SYS1 -> IDOD_SG_LCR_LOANDEPO_SYS1  4.00 IDOD_SG_LCR_LOANDEPO_SYS1 -> IDOD_SG_LCR_LOANDEPO2_SYS1  1.00 IDOD_SG_LCR_LOANDEPO2_SYS1 -> IDOD_SG_LCR_LOANDEPO40_SYS1  1.00 IDOD_SG_LCR_LOANDEPO40_SYS1 -> IDOD_SG_LCR_LOANDEPO9_SYS1  1.00 IDOD_SG_LCR_LOANDEPO9_SYS1 -> IDOD_SG_LCR_LOANDEPO10_SYS1  1.00 IDOD_SG_LCR_LOANDEPO10_SYS1 -> IDOD_SG_LCR_LOANDEPO11_SYS1  1.00 IDOD_SG_LCR_LOANDEPO11_SYS1 -> IDOD_SG_LCR_LOANDEPO12_SYS1  1.00 IDOD_SG_LCR_LOANDEPO12_SYS1 -> IDOD_SG_LCR_LOANDEPO14_SYS1  1.00 IDOD_SG_LCR_LOANDEPO14_SYS1 -> IDOD_SG_LCR_LOANDEPO15_SYS1  1.00 IDOD_SG_LCR_LOANDEPO15_SYS1 -> IDOD_SG_LCR_LOANDEPO16_SYS1  1.00 IDOD_SG_LCR_LOANDEPO16_SYS1 -> IDOD_SG_LCR_LOANDEPO217_SYS1  1.00 IDOD_SG_LCR_LOANDEPO217_SYS1 -> IDOD_SG_LCR_LOANDEPO218_SYS1  1.00 IDOD_SG_LCR_LOANDEPO218_SYS1 -> IDOD_SG_LCR_LOANDEPO219_SYS1  1.00 IDOD_SG_LCR_LOANDEPO219_SYS1 -> IDOD_SG_LCR_LOANDEPO220_SYS1  1.00 IDOD_SG_LCR_LOANDEPO220_SYS1 -> IDOD_SG_LCR_LOANDEPO221_SYS1  1.00 IDOD_SG_LCR_LOANDEPO221_SYS1 -> IDOD_SG_LCR_LOANDEPO222_SYS1  1.00 IDOD_SG_LCR_LOANDEPO222_SYS1 -> IDOD_SG_LCR_LOANDEPO223_SYS1  1.00 IDOD_SG_LCR_LOANDEPO223_SYS1 -> IDOD_SG_LCR_LOANDEPO224_SYS1  1.00 IDOD_SG_LCR_LOANDEPO224_SYS1 -> IDOD_SG_LCR_LOANDEPO225_SYS1  1.00 IDOD_SG_LCR_LOANDEPO225_SYS1 -> IDOD_SG_LCR_LOANDEPO226_SYS1  1.00 IDOD_SG_LCR_LOANDEPO226_SYS1 -> IDOD_SG_LCR_LOANDEPO227_SYS1  1.00 IDOD_SG_LCR_LOANDEPO227_SYS1 -> IDOD_SG_LCR_LOANDEPO228_SYS1  1.00 IDOD_SG_LCR_LOANDEPO228_SYS1 -> IDOD_SG_LCR_LOANDEPO229_SYS1  1.00 IDOD_SG_LCR_LOANDEPO229_SYS1 -> IDOD_SG_LCR_LOANDEPO230_SYS1  1.00 IDOD_SG_LCR_LOANDEPO230_SYS1 -> PDM_SG_RM_FPRO_SELL_BUY_SYS1  1.00",
    "APP_CODE IDOD_SG_LCR_LOANDEPO5_SYS1 to PDM_SG_RM_FPRO_SELL_BUY_SYS1 (28.00) IDOD_SG_LCR_LOANDEPO5_SYS1 -> IDOD_SG_LCR_LOANDEPO_SYS1  6.00 IDOD_SG_LCR_LOANDEPO_SYS1 -> IDOD_SG_LCR_LOANDEPO2_SYS1  1.00 IDOD_SG_LCR_LOANDEPO2_SYS1 -> IDOD_SG_LCR_LOANDEPO40_SYS1  1.00 IDOD_SG_LCR_LOANDEPO40_SYS1 -> IDOD_SG_LCR_LOANDEPO9_SYS1  1.00 IDOD_SG_LCR_LOANDEPO9_SYS1 -> IDOD_SG_LCR_LOANDEPO210_SYS1  1.00 IDOD_SG_LCR_LOANDEPO210_SYS1 -> IDOD_SG_LCR_LOANDEPO211_SYS1  1.00 IDOD_SG_LCR_LOANDEPO211_SYS1 -> IDOD_SG_LCR_LOANDEPO212_SYS1  1.00 IDOD_SG_LCR_LOANDEPO212_SYS1 -> IDOD_SG_LCR_LOANDEPO214_SYS1  1.00 IDOD_SG_LCR_LOANDEPO214_SYS1 -> IDOD_SG_LCR_LOANDEPO215_SYS1  1.00 IDOD_SG_LCR_LOANDEPO215_SYS1 -> IDOD_SG_LCR_LOANDEPO216_SYS1  1.00 IDOD_SG_LCR_LOANDEPO216_SYS1 -> IDOD_SG_LCR_LOANDEPO217_SYS1  1.00 IDOD_SG_LCR_LOANDEPO217_SYS1 -> IDOD_SG_LCR_LOANDEPO218_SYS1  1.00 IDOD_SG_LCR_LOANDEPO218_SYS1 -> IDOD_SG_LCR_LOANDEPO219_SYS1  1.00 IDOD_SG_LCR_LOANDEPO219_SYS1 -> IDOD_SG_LCR_LOANDEPO220_SYS1  1.00 IDOD_SG_LCR_LOANDEPO220_SYS1 -> IDOD_SG_LCR_LOANDEPO221_SYS1  1.00 IDOD_SG_LCR_LOANDEPO221_SYS1 -> IDOD_SG_LCR_LOANDEPO222_SYS1  1.00 IDOD_SG_LCR_LOANDEPO222_SYS1 -> IDOD_SG_LCR_LOANDEPO223_SYS1  1.00 IDOD_SG_LCR_LOANDEPO223_SYS1 -> IDOD_SG_LCR_LOANDEPO224_SYS1  1.00 IDOD_SG_LCR_LOANDEPO224_SYS1 -> IDOD_SG_LCR_LOANDEPO225_SYS1  1.00 IDOD_SG_LCR_LOANDEPO225_SYS1 -> IDOD_SG_LCR_LOANDEPO226_SYS1  1.00 IDOD_SG_LCR_LOANDEPO226_SYS1 -> IDOD_SG_LCR_LOANDEPO227_SYS1  1.00 IDOD_SG_LCR_LOANDEPO227_SYS1 -> IDOD_SG_LCR_LOANDEPO228_SYS1  1.00 IDOD_SG_LCR_LOANDEPO228_SYS1 -> IDOD_SG_LCR_LOANDEPO229_SYS1  1.00 IDOD_SG_LCR_LOANDEPO229_SYS1 -> IDOD_SG_LCR_LOANDEPO230_SYS1  1.00 IDOD_SG_LCR_LOANDEPO230_SYS1 -> PDM_SG_RM_FPRO_SELL_BUY_SYS1  1.00",
  ...
  parseJob(): void {
    ...
    this.treeData = { name: key, children: jobData[key].children, isCriticalPath: true };
    // const allPaths = this.findPaths(this.treeData, [], {});
    // console.log(allPaths);
  }
  ...
  findRootNode(map: any): any {
    ...
    for (let key of map.keys()) {
      ...
      if (!chartData[jobName]) {
        chartData[jobName] = { name: jobName, children: [], isCriticalPath: true, value: val.value };
      }

      const targetJob = this.traverse(0, val.paths, chartData[jobName].children, globalEntry, val.isCriticalPath, {});
      totalVal[targetJob] = parseFloat(val.value);
    }
  ...
  traverse(index: any, paths: any, child: any, globalEntry: any, isCriticalPath: boolean, parent: any): any {
    ...
    const i = child.findIndex((el: any) => jobName === el.name);
    if (i === -1) {
      if (globalEntry[jobName] > 0) {
        globalEntry[jobName]++;
        child.push({ name: jobName + "DUPLICATE_" + globalEntry[jobName], value: paths[index].value, children: [], actualJobName: jobName, isCriticalPath });
      } else {
        globalEntry[jobName] = 1;
        child.push({ name: jobName, value: paths[index].value, children: [], isCriticalPath });
      }
  ...
  private checkNodeAlreadyPresent(arr: Array<any>, currCtx: any, chartData: any): boolean {
    const index = arr.findIndex((el: any) => (el.source === currCtx.source && el.target === currCtx.target));
    // if(index > -1 && chartData[currCtx.target]?.length) {
    //   arr.push({ name: currCtx.target + "DUPLICATE_1" , value: currCtx.value, source: currCtx.source, target: currCtx.target });
    // }
